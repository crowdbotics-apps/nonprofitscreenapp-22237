...
const initialState = { nonProfitScreenAppAPI: [] }

export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.API_V1_CALL_LIST:
    case types.API_V1_CALL_LIST_SUCCEEDED:
    case types.API_V1_CALL_LIST_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_CALL_CREATE:
    case types.API_V1_CALL_CREATE_SUCCEEDED:
    case types.API_V1_CALL_CREATE_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_CALL_READ:
    case types.API_V1_CALL_READ_SUCCEEDED:
    case types.API_V1_CALL_READ_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_CALL_UPDATE:
    case types.API_V1_CALL_UPDATE_SUCCEEDED:
    case types.API_V1_CALL_UPDATE_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_CALL_PARTIAL_UPDATE:
    case types.API_V1_CALL_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_CALL_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_CALL_DELETE:
    case types.API_V1_CALL_DELETE_SUCCEEDED:
    case types.API_V1_CALL_DELETE_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    ...
    case types.API_V1_PHONE_LIST:
    case types.API_V1_PHONE_LIST_SUCCEEDED:
    case types.API_V1_PHONE_LIST_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_PHONE_CREATE:
    case types.API_V1_PHONE_CREATE_SUCCEEDED:
    case types.API_V1_PHONE_CREATE_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_PHONE_READ:
    case types.API_V1_PHONE_READ_SUCCEEDED:
    case types.API_V1_PHONE_READ_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_PHONE_UPDATE:
    case types.API_V1_PHONE_UPDATE_SUCCEEDED:
    case types.API_V1_PHONE_UPDATE_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_PHONE_PARTIAL_UPDATE:
    case types.API_V1_PHONE_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_PHONE_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
    case types.API_V1_PHONE_DELETE:
    case types.API_V1_PHONE_DELETE_SUCCEEDED:
    case types.API_V1_PHONE_DELETE_FAILED:
      return Object.assign({}, state, {
        nonProfitScreenAppAPI: [...state.nonProfitScreenAppAPI, action.response]
      })
