...
function* api_v1_call_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_call_list, action)
    yield put(actions.api_v1_call_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_call_listFailed(err, action))
  }
}
function* api_v1_call_listWatcher() {
  yield takeEvery(types.API_V1_CALL_LIST, api_v1_call_listWorker)
}
function* api_v1_call_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_call_create, action)
    yield put(actions.api_v1_call_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_call_createFailed(err, action))
  }
}
function* api_v1_call_createWatcher() {
  yield takeEvery(types.API_V1_CALL_CREATE, api_v1_call_createWorker)
}
function* api_v1_call_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_call_read, action)
    yield put(actions.api_v1_call_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_call_readFailed(err, action))
  }
}
function* api_v1_call_readWatcher() {
  yield takeEvery(types.API_V1_CALL_READ, api_v1_call_readWorker)
}
function* api_v1_call_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_call_update, action)
    yield put(actions.api_v1_call_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_call_updateFailed(err, action))
  }
}
function* api_v1_call_updateWatcher() {
  yield takeEvery(types.API_V1_CALL_UPDATE, api_v1_call_updateWorker)
}
function* api_v1_call_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_call_partial_update, action)
    yield put(actions.api_v1_call_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_call_partial_updateFailed(err, action))
  }
}
function* api_v1_call_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_CALL_PARTIAL_UPDATE,
    api_v1_call_partial_updateWorker
  )
}
function* api_v1_call_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_call_delete, action)
    yield put(actions.api_v1_call_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_call_deleteFailed(err, action))
  }
}
function* api_v1_call_deleteWatcher() {
  yield takeEvery(types.API_V1_CALL_DELETE, api_v1_call_deleteWorker)
}
...
function* api_v1_phone_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_phone_list, action)
    yield put(actions.api_v1_phone_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_phone_listFailed(err, action))
  }
}
function* api_v1_phone_listWatcher() {
  yield takeEvery(types.API_V1_PHONE_LIST, api_v1_phone_listWorker)
}
function* api_v1_phone_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_phone_create, action)
    yield put(actions.api_v1_phone_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_phone_createFailed(err, action))
  }
}
function* api_v1_phone_createWatcher() {
  yield takeEvery(types.API_V1_PHONE_CREATE, api_v1_phone_createWorker)
}
function* api_v1_phone_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_phone_read, action)
    yield put(actions.api_v1_phone_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_phone_readFailed(err, action))
  }
}
function* api_v1_phone_readWatcher() {
  yield takeEvery(types.API_V1_PHONE_READ, api_v1_phone_readWorker)
}
function* api_v1_phone_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_phone_update, action)
    yield put(actions.api_v1_phone_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_phone_updateFailed(err, action))
  }
}
function* api_v1_phone_updateWatcher() {
  yield takeEvery(types.API_V1_PHONE_UPDATE, api_v1_phone_updateWorker)
}
function* api_v1_phone_partial_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_phone_partial_update, action)
    yield put(actions.api_v1_phone_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_phone_partial_updateFailed(err, action))
  }
}
function* api_v1_phone_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_PHONE_PARTIAL_UPDATE,
    api_v1_phone_partial_updateWorker
  )
}
function* api_v1_phone_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_phone_delete, action)
    yield put(actions.api_v1_phone_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_phone_deleteFailed(err, action))
  }
}
function* api_v1_phone_deleteWatcher() {
  yield takeEvery(types.API_V1_PHONE_DELETE, api_v1_phone_deleteWorker)
}
...
export default function* rootSaga() {
  const sagas = [
    api_v1_call_listWatcher,
    api_v1_call_createWatcher,
    api_v1_call_readWatcher,
    api_v1_call_updateWatcher,
    api_v1_call_partial_updateWatcher,
    api_v1_call_deleteWatcher,
    ...
    api_v1_phone_listWatcher,
    api_v1_phone_createWatcher,
    api_v1_phone_readWatcher,
    api_v1_phone_updateWatcher,
    api_v1_phone_partial_updateWatcher,
    api_v1_phone_deleteWatcher,
