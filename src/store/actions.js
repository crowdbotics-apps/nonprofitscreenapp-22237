...
export const api_v1_call_list = () => ({ type: types.API_V1_CALL_LIST })
export const api_v1_call_listSucceeded = (response, starter) => ({
  type: types.API_V1_CALL_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_call_listFailed = (error, starter) => ({
  type: types.API_V1_CALL_LIST_FAILED,
  error,
  starter
})
export const api_v1_call_create = data => ({
  type: types.API_V1_CALL_CREATE,
  data
})
export const api_v1_call_createSucceeded = (response, starter) => ({
  type: types.API_V1_CALL_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_call_createFailed = (error, starter) => ({
  type: types.API_V1_CALL_CREATE_FAILED,
  error,
  starter
})
export const api_v1_call_read = () => ({ type: types.API_V1_CALL_READ })
export const api_v1_call_readSucceeded = (response, starter) => ({
  type: types.API_V1_CALL_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_call_readFailed = (error, starter) => ({
  type: types.API_V1_CALL_READ_FAILED,
  error,
  starter
})
export const api_v1_call_update = data => ({
  type: types.API_V1_CALL_UPDATE,
  data
})
export const api_v1_call_updateSucceeded = (response, starter) => ({
  type: types.API_V1_CALL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_call_updateFailed = (error, starter) => ({
  type: types.API_V1_CALL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_call_partial_update = data => ({
  type: types.API_V1_CALL_PARTIAL_UPDATE,
  data
})
export const api_v1_call_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_CALL_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_call_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_CALL_PARTIAL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_call_delete = () => ({ type: types.API_V1_CALL_DELETE })
export const api_v1_call_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_CALL_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_call_deleteFailed = (error, starter) => ({
  type: types.API_V1_CALL_DELETE_FAILED,
  error,
  starter
})
...
export const api_v1_phone_list = () => ({ type: types.API_V1_PHONE_LIST })
export const api_v1_phone_listSucceeded = (response, starter) => ({
  type: types.API_V1_PHONE_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_phone_listFailed = (error, starter) => ({
  type: types.API_V1_PHONE_LIST_FAILED,
  error,
  starter
})
export const api_v1_phone_create = data => ({
  type: types.API_V1_PHONE_CREATE,
  data
})
export const api_v1_phone_createSucceeded = (response, starter) => ({
  type: types.API_V1_PHONE_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_phone_createFailed = (error, starter) => ({
  type: types.API_V1_PHONE_CREATE_FAILED,
  error,
  starter
})
export const api_v1_phone_read = () => ({ type: types.API_V1_PHONE_READ })
export const api_v1_phone_readSucceeded = (response, starter) => ({
  type: types.API_V1_PHONE_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_phone_readFailed = (error, starter) => ({
  type: types.API_V1_PHONE_READ_FAILED,
  error,
  starter
})
export const api_v1_phone_update = data => ({
  type: types.API_V1_PHONE_UPDATE,
  data
})
export const api_v1_phone_updateSucceeded = (response, starter) => ({
  type: types.API_V1_PHONE_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_phone_updateFailed = (error, starter) => ({
  type: types.API_V1_PHONE_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_phone_partial_update = data => ({
  type: types.API_V1_PHONE_PARTIAL_UPDATE,
  data
})
export const api_v1_phone_partial_updateSucceeded = (response, starter) => ({
  type: types.API_V1_PHONE_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_phone_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_PHONE_PARTIAL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_phone_delete = () => ({ type: types.API_V1_PHONE_DELETE })
export const api_v1_phone_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_PHONE_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_phone_deleteFailed = (error, starter) => ({
  type: types.API_V1_PHONE_DELETE_FAILED,
  error,
  starter
})
